...
def create_node_config(oci_config, hostname: str, ip: Optional[str], nodespace: Dict[str, str], ssh_keys: str) -> oci.core.models.LaunchInstanceDetails:
    ...
    image_name = "Oracle Linux 7 - HPC Cluster Networking Image"
    image = get_images()["Oracle-Linux-7.6-2019.02.20-0"][nodespace["region"]]
...
def get_images() -> Dict[str, Dict[str, str]]:
    ...
    return {
        ...
        "Oracle-Linux-7.6-2019.02.20-0": {
            ...
            "us-ashburn-1": "ocid1.image.oc1..aaaaaaaafgzcla4pkskkegec3okzhbtmaylnldbxoa4ln7d6npytnqwu3mca",
